...
## @mainpage
## @n
## **This version is forked from https://github.com/SkypLabs/bsfl by the OVYA Team**
## @line
...
## @brief The Bash Shell Function Library (BSFL) is a small Bash script that acts as a library
## for bash scripts. It provides a couple of functions that makes the lives of most
## people using shell scripts a bit easier.
## @copyright New BSD
## @version 0.1.0
## @par URL
## https://github.com/OVYA/bsfl forked from https://github.com/SkypLabs/bsfl
